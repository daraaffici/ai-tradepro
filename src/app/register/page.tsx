...
export default function RegisterPage() {
  ...
  function socialRegister(provider: string) {
    alert(`${provider} register will be added later with OAuth.`);
  }
    ...
    <div className="min-h-screen flex items-center justify-center text-white p-4 relative overflow-hidden bg-black">
      ...
      <div className="relative z-10 w-full max-w-md bg-zinc-900/90 backdrop-blur p-8 rounded-2xl border border-zinc-700 shadow-2xl">
        ...
        <div className="grid grid-cols-2 gap-3 mb-4">
          <button onClick={() => socialRegister("Google")} className="bg-white text-black p-3 rounded-lg font-bold">
            Google
          </button>
          <button onClick={() => socialRegister("Facebook")} className="bg-blue-600 p-3 rounded-lg font-bold">
            Facebook
          </button>
        </div>
